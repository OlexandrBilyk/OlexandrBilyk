...
<div style="display: flex; align-items: center; justify-content: flex-end; gap: 20px; max-width: 600px; margin-left: auto;">

  <img src="https://media.giphy.com/media/l3vR85PnGsBwu1PFK/giphy.gif" alt="Naruto GIF" width="120" style="border-radius: 8px;" />

  <div style="display: flex; flex-wrap: wrap; gap: 6px; max-width: 440px;">
